    ...
    <div className="py-12 md:py-20">
      <div className="container max-w-4xl px-4 md:px-8">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-foreground mx-auto">
          ...
          <h2>8. Contact Us</h2>
          <p>
            If you have any questions about these Terms, please contact us by email at: <a href="mailto:hello@freightsync.in" className="text-primary hover:underline">hello@freightsync.in</a>.
          </p>
        </div>
      </div>
    </div>
