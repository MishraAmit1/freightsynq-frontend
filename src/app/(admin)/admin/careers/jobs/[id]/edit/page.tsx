...
import { getJobById, updateJob, getAllDepartments } from '@/lib/api/admin'
import {
    Save,
    ChevronLeft,
    AlertCircle,
...
export default function EditJobPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const { error } = await updateJob(id, formData)
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-2">Update job: {formData.title}</p>
            </div>
